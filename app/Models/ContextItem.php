...
/**
 * ContextItem model - ordered list of messages and summaries forming conversation context.
 *
 ...
 * @property string|null $summary_id FK to summaries.summary_id (if summary type)
...
class ContextItem extends Model
{
    ...
    {
        return $this->belongsTo(Summary::class, 'summary_id', 'summary_id');
    }
